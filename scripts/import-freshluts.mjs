...
const GAMMA_MAP = {
  ...
  "arri log c":              { transfer: "arri-logc3-ei800",    gamut: "arri-wide-gamut-3" },
  "sony s-log":              { transfer: "sony-s-log1",         gamut: "sony-s-gamut" },
  "sony s-log 2":            { transfer: "sony-s-log2",         gamut: "sony-s-gamut" },
  "sony s-log 3":            { transfer: "sony-s-log3",         gamut: "sony-s-gamut3" },
  "panasonic v-log":         { transfer: "panasonic-v-log",     gamut: "panasonic-v-gamut" },
  "panasonic v-log l":       { transfer: "panasonic-v-log-l",   gamut: "panasonic-v-gamut" },
  "panasonic cinelike-d":    { transfer: "panasonic-cinelike-d", gamut: "rec709" },
  "dji d-log":               { transfer: "dji-d-log",           gamut: "dji-d-gamut" },
  "red log film":            { transfer: "red-logfilm",         gamut: "red-wide-gamut-rgb" },
  "red color":               { transfer: "unspecified",         gamut: "red-wide-gamut-rgb" },
  "blackmagic bmd film":     { transfer: "bmd-film",            gamut: "bmd-film-gamut" },
  "blackmagic bmd film 4k":  { transfer: "bmd-film-4k",         gamut: "bmd-film-gamut" },
  "canon cinestyle":         { transfer: "canon-cinestyle",     gamut: "rec709" },
  "canon c-log":             { transfer: "canon-log",           gamut: "canon-cinema-gamut" },
  "canon c-log 2":           { transfer: "canon-log2",          gamut: "canon-cinema-gamut" },
  "canon c-log 3":           { transfer: "canon-log3",          gamut: "canon-cinema-gamut" },
  "gopro protune":           { transfer: "gopro-protune",       gamut: "gopro-protune-native" },
...
function buildHeader(meta, body, sourceRel, hash, duplicateAssets = []) {
  ...
  const fields = [
    ...
    ["Color-Space-Confidence", inputId ? "declared-by-source" : "camera-profile-input-required"],
