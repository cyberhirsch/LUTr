...
function colorParts(id) {
  return {
    ...
    "cie-xyz-d65": ["cie-xyz-d65", "linear"],
    "rec709-gamma18": ["rec709", "gamma18"],
    "rec709-gamma22": ["rec709", "gamma22"],
    "linear-adobe-rgb": ["adobe-rgb", "linear"],
    "adobe-rgb-gamma22": ["adobe-rgb", "gamma22"],
    "acescg-gamma22": ["aces-ap1", "gamma22"],
    "acescg-srgb": ["aces-ap1", "srgb"],
    "apple-log-bt2020": ["rec2020", "apple-log"],
    "arri-logc4-awg4": ["arri-wide-gamut-4", "arri-logc4"],
    "linear-arri-wide-gamut3": ["arri-wide-gamut-3", "linear"],
    "linear-arri-wide-gamut4": ["arri-wide-gamut-4", "linear"],
    "bmd-film-gen5-widegamut": ["blackmagic-wide-gamut", "blackmagic-film-gen5"],
    "linear-bmd-widegamut": ["blackmagic-wide-gamut", "linear"],
    "davinci-intermediate-widegamut": ["davinci-wide-gamut", "davinci-intermediate"],
    "linear-davinci-widegamut": ["davinci-wide-gamut", "linear"],
    "linear-canon-cinema-gamut": ["canon-cinema-gamut", "linear"],
    "linear-dji-dgamut": ["dji-d-gamut", "linear"],
    "linear-panasonic-vgamut": ["panasonic-v-gamut", "linear"],
    "red-log3g10-rwg": ["red-wide-gamut-rgb", "red-log3g10"],
    "linear-red-wide-gamut": ["red-wide-gamut-rgb", "linear"],
    "linear-sony-sgamut": ["sony-s-gamut", "linear"],
    "linear-sony-sgamut3": ["sony-s-gamut3", "linear"],
    "sony-slog3-sgamut3cine": ["sony-s-gamut3-cine", "sony-s-log3"],
    "linear-sony-sgamut3cine": ["sony-s-gamut3-cine", "linear"],
    "sony-slog3-venice-sgamut3": ["sony-venice-s-gamut3", "sony-s-log3"],
    "linear-sony-venice-sgamut3": ["sony-venice-s-gamut3", "linear"],
    "sony-slog3-venice-sgamut3cine": ["sony-venice-s-gamut3-cine", "sony-s-log3"],
    "linear-sony-venice-sgamut3cine": ["sony-venice-s-gamut3-cine", "linear"],
...
function descriptorColorSpace(descriptor = "") {
  ...
  const exact = {
    "apple log": "apple-log-bt2020",
    "arri logc3 (ei800)": "arri-logc3-ei800-awg3",
    "arri logc4": "arri-logc4-awg4",
    "linear arri wide gamut 3": "linear-arri-wide-gamut3",
    "linear arri wide gamut 4": "linear-arri-wide-gamut4",
    "blackmagic film wide gamut (gen 5)": "bmd-film-gen5-widegamut",
    "linear blackmagic wide gamut (gen 5)": "linear-bmd-widegamut",
    "davinci intermediate wide gamut": "davinci-intermediate-widegamut",
    "linear davinci wide gamut": "linear-davinci-widegamut",
    "canon log 2 cinema gamut (daylight)": "canon-log2-cinema-gamut",
    "canon log 3 cinema gamut (daylight)": "canon-log3-cinema-gamut",
    "linear canon cinema gamut (daylight)": "linear-canon-cinema-gamut",
    "dji d-log - d-gamut": "dji-dlog-dgamut",
    "linear dji d-gamut": "linear-dji-dgamut",
    "cie xyz, d65 white point": "cie-xyz-d65",
    "1.8 gamma-corrected rec.709 primaries, d65 white point": "rec709-gamma18",
    "2.2 gamma-corrected adobergb primaries, d65 white point": "adobe-rgb-gamma22",
    "2.2 gamma-corrected ap1 primaries, aces ~=d60 white point": "acescg-gamma22",
    "2.2 gamma-corrected rec.709 primaries, d65 white point": "rec709-gamma22",
    "linear adobe rgb (1998) primaries, d65 white point": "linear-adobe-rgb",
    "srgb encoded ap1 primaries, aces ~=d60 white point": "acescg-srgb",
    "srgb encoded p3-d65 primaries, d65 white point": "display-p3",
    "linear panasonic v-gamut": "linear-panasonic-vgamut",
    "panasonic v-log - v-gamut": "panasonic-vlog-vgamut",
    "linear redwidegamutrgb": "linear-red-wide-gamut",
    "red log3g10 redwidegamutrgb": "red-log3g10-rwg",
    "linear s-gamut": "linear-sony-sgamut",
    "linear s-gamut3": "linear-sony-sgamut3",
    "linear s-gamut3.cine": "linear-sony-sgamut3cine",
    "linear venice s-gamut3": "linear-sony-venice-sgamut3",
    "linear venice s-gamut3.cine": "linear-sony-venice-sgamut3cine",
    "sony s-log2 s-gamut": "sony-slog2-sgamut",
    "sony s-log3 s-gamut3": "sony-slog3-sgamut3",
    "sony s-log3 s-gamut3.cine": "sony-slog3-sgamut3cine",
    "sony s-log3 venice s-gamut3": "sony-slog3-venice-sgamut3",
    "sony s-log3 venice s-gamut3.cine": "sony-slog3-venice-sgamut3cine",
  };
